<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\phpStudy\PHPTutorial\WWW\lfgj-1/application/admin\view\user\edit.html";i:1536411047;s:74:"D:\phpStudy\PHPTutorial\WWW\lfgj-1\application\admin\view\index\index.html";i:1536411045;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main-content  ">
    <div class="wrapper">
        <ol class="breadcrumb">
            <li>
                <span class="gray-color">用户管理 -</span>
                <span class="lgray-color">编辑账户</span>
            </li>
        </ol>
        <div class="panel min-body">
            <div class="panel-body">
                <div class="main-heading"> <i class="icon icon-stop"></i> 编辑账户</div>
                <form class="form-horizontal" action='/admin/user/edit' method="post">
                    <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                    <div class="form-group">
                        <label class="col-sm-2">手机号
                        </label>
                        <div class="col-md-6 col-sm-10">
                            <input type="text" class="form-control"   name="utel" value="<?php echo $user['utel']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-10">
                            <input type="text" class="form-control"  name="upass" value="<?php echo $user['upass']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label  class="col-sm-2">邀请码
                        </label>
                        <div class="col-md-6 col-sm-10">
                            <input type="text" class="form-control" name='invite'  value="<?php echo $user['invite']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    <label  class="col-sm-2">状态
                    </label>
                    <div class="col-md-6 col-sm-10">
                        <input type="text" class="form-control" name='invite'  value="<?php echo status($user['status']); ?>">
                    </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-10">
                            ...
                            <button type="button" name="gbbutton"  class="return-btn " onclick="history.go(-1)">返回</button>&nbsp;&nbsp;
                        </div>
                    </div>
                </form>
            </div>
