<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\PHPTutorial\WWW\lfgj-1/application/admin\view\account\index.html";i:1536411048;s:74:"D:\phpStudy\PHPTutorial\WWW\lfgj-1\application\admin\view\index\index.html";i:1536411045;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                   ...
                   <span class="pull-left"><i class="icon icon-stop"></i> 所有账户<?php echo $lists->total(); ?>位</span>
                    ...
                    <table class="table table-center table-bordered">
                        ...
                        <tbody id="tr_html">
                        <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$account): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td><?php echo $account['ctime']; ?></td>
                                <td><?php echo $account['utime']; ?></td>
                                <td>
                                    <a href="/admin/account/edit/id/<?php echo $account['id']; ?>"><button class="btn"><i class="icon icon-file-text-o"></i> 编辑</button></a>
