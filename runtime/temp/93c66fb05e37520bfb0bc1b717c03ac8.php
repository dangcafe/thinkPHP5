<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"/data/www/lfgj/application/admin/view/agent/index.html";i:1532596177;s:54:"/data/www/lfgj/application/admin/view/index/index.html";i:1531358923;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="wrapper">
            ...
            <div class="panel">
                <div class="panel-body">
                   ...
                   <span class="pull-left"><i class="icon icon-stop"></i> 所有账户<?php echo $agentlist->total(); ?>位</span>
                    ...
                    <table class="table table-center table-bordered">
                        ...
                        <tbody id="tr_html">
                        <?php if(is_array($agentlist) || $agentlist instanceof \think\Collection || $agentlist instanceof \think\Paginator): $i = 0; $__LIST__ = $agentlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><?php echo $user['id']; ?></td>
                                <td><?php echo $user['agentnum']; ?></td>
                                <td><?php echo $user['username']; ?></td>
                                <td><?php echo $user['mobile']; ?></td>
                                <td><?php echo $user['banknum']; ?></td>
                                <td><?php echo $user['banklocal']; ?></td>
                                <td><?php echo $user['bindphone']; ?></td>
                                <td><?php echo $user['ppnum']; ?></td>
                                <td>
                                    <?php if($user['img1'] != null): ?>
                                        <img src="<?php echo $user['img1']; ?>" style="width:100px;height:100px;">
                                    <?php else: ?> 
                                    还未上传
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($user['img2'] != null): ?>
                                        <img src="<?php echo $user['img2']; ?>" style="width:100px;height:100px;">
                                    <?php else: ?> 
                                    还未上传
                                    <?php endif; ?>
                                </td>
                                <td><?php echo $user['company']; ?></td>
                                <td><?php echo $user['ceo']; ?></td>
                                <td><?php echo $user['ppnumceo']; ?></td>
                                <td>
                                    <?php if($user['img3'] != null): ?>
                                        <img src="<?php echo $user['img3']; ?>" style="width:100px;height:100px;">
                                    <?php else: ?> 
                                    还未上传
                                    <?php endif; ?>
                                </td>                                
                                <td>
                                    <?php if($user['img4'] != null): ?>
                                        <img src="<?php echo $user['img4']; ?>" style="width:100px;height:100px;">
                                    <?php else: ?> 
                                    还未上传
                                    <?php endif; ?>
                                </td>                                
                                <td>
                                    <?php if($user['img5'] != null): ?>
                                        <img src="<?php echo $user['img5']; ?>" style="width:100px;height:100px;">
                                    <?php else: ?> 
                                    还未上传
                                    <?php endif; ?>
                                </td>
